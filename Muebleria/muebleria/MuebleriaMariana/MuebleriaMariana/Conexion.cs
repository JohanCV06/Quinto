...
namespace Basededatos
{
    public class Conexion
    {
        ...
        String strcomando;
        String strconexion = "Provider=SQLOLEDB;Data Source=192.168.59.150;Initial Catalog=JohanBase2008228;Persist Security Info=True;User ID=desarrollo;Password=pass123";
