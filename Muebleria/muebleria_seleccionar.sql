...
/* Created on:     06/08/2018 12:44:50                          */
/*==============================================================*/
...
if exists (select 1
          from sysobjects
          where  id = object_id('SELECCIONARCOMPONENTE')
          and type in ('P','PC'))
   drop procedure SELECCIONARCOMPONENTE
go

if exists (select 1
          from sysobjects
          where  id = object_id('SELECCIONARCOMPONENTEMODULO')
          and type in ('P','PC'))
   drop procedure SELECCIONARCOMPONENTEMODULO
go

if exists (select 1
          from sysobjects
          where  id = object_id('SELECCIONARCROQUIS')
          and type in ('P','PC'))
   drop procedure SELECCIONARCROQUIS
go

if exists (select 1
          from sysobjects
          where  id = object_id('SELECCIONARMODULO')
          and type in ('P','PC'))
   drop procedure SELECCIONARMODULO
go

if exists (select 1
          from sysobjects
          where  id = object_id('SELECCIONARMODULOCROQUIS')
          and type in ('P','PC'))
   drop procedure SELECCIONARMODULOCROQUIS
go

if exists (select 1
          from sysobjects
          where  id = object_id('SELECCIONARPIEZA')
          and type in ('P','PC'))
   drop procedure SELECCIONARPIEZA
go

if exists (select 1
          from sysobjects
          where  id = object_id('SELECCIONARPIEZACOMPONENTE')
          and type in ('P','PC'))
   drop procedure SELECCIONARPIEZACOMPONENTE
go
...
create procedure ACTUALIZAR_PIEZA  @ID_PIEZA numeric,@NOMBRE_PIEZA varchar(15),@DESCRIPCION varchar(15),@FOTO1_PIEZA varchar(max),@FOTO2_PIEZA varchar(MAX),@PRECIO_PIEZA decimal,@UNIDAD_MEDIDA varchar(15) as
begin
update PIEZA
...
create procedure INSERTAR_PIEZA  @ID_PIEZA numeric,@NOMBRE_PIEZA varchar(15),@DESCRIPCION varchar(15),@FOTO1_PIEZA varchar(max),@FOTO2_PIEZA varchar(MAX),@PRECIO_PIEZA decimal,@UNIDAD_MEDIDA varchar(15) as
begin
...
create procedure SELECCIONARCOMPONENTE  @ID_COMPONENTE numeric as
begin
...
create procedure SELECCIONARCOMPONENTEMODULO  @ID_MODULO numeric,@ID_COMPONENTE numeric as
begin
select * from COMPONENTE_MODULO
where COMPONENTE_MODULO.ID_MODULO = @ID_MODULO and COMPONENTE_MODULO.ID_COMPONENTE = @ID_COMPONENTE
end
go

create procedure SELECCIONARCROQUIS  @ID_CROQUIS numeric as
begin
select * from CROQUIS
where CROQUIS.ID_CROQUIS = @ID_CROQUIS
end
...
create procedure SELECCIONARMODULO  @ID_MODULO numeric as
begin
select * from MODULO
where MODULO.ID_MODULO = @ID_MODULO
end
...
create procedure SELECCIONARMODULOCROQUIS  @ID_MODULO numeric,@ID_CROQUIS numeric as
begin
select * from MODULO_CROQUIS
where MODULO_CROQUIS.ID_MODULO = @ID_MODULO and MODULO_CROQUIS.ID_CROQUIS = @ID_CROQUIS
end
go

create procedure SELECCIONARPIEZA  @ID_PIEZA numeric,@NOMBRE_PIEZA varchar(15),@DESCRIPCION varchar(15),@FOTO1_PIEZA varchar(max),@FOTO2_PIEZA varchar(MAX),@PRECIO_PIEZA decimal,@UNIDAD_MEDIDA varchar(15) as
begin
update PIEZA
set PIEZA.NOMBRE_PIEZA = @NOMBRE_PIEZA, PIEZA.DESCRIPCION = @DESCRIPCION, PIEZA.FOTO1_PIEZA = @FOTO1_PIEZA, PIEZA.FOTO2_PIEZA = @FOTO2_PIEZA, PIEZA.PRECIO_PIEZA = @PRECIO_PIEZA, PIEZA.UNIDAD_MEDIDA = @UNIDAD_MEDIDA
where (PIEZA.ID_PIEZA = @ID_PIEZA)
...
create procedure SELECCIONARPIEZACOMPONENTE  @ID_PIEZA numeric,@ID_COMPONENTE numeric as
begin
select * from PIEZA_COMPONENTE
where PIEZA_COMPONENTE.ID_PIEZA = @ID_PIEZA and PIEZA_COMPONENTE.ID_COMPONENTE = @ID_COMPONENTE
end
go
